...
const menuCategories: MenuCategory[] = [
  {
    ...
    items: [
      { nameDe: "Bratlbrot", nameEn: "Roast Pork Bread", price: "€8,90", allergens: ["A", "M"] },
      { nameDe: "Brot mit geselchtem Fleisch", nameEn: "Bread with Smoked Meat", price: "€8,90", allergens: ["A", "M"] },
      { nameDe: "Bratlfettbrot", nameEn: "Lard Bread", price: "€4,90", allergens: ["A", "M"] },
      { nameDe: "Steirerkas-Brot", nameEn: "Styrian Cheese Bread", price: "€5,60", allergens: ["A", "G", "M"], vegetarian: true },
      { nameDe: "Käse Brot mit Schnittkäse", nameEn: "Cheese Bread", price: "€7,70", allergens: ["A", "G", "M"], vegetarian: true },
      { nameDe: "Gemischtes Brot", nameEn: "Mixed Bread Platter", descDe: "Käse, Bratl und Speck", descEn: "Cheese, roast pork and bacon", price: "€9,90", allergens: ["A", "G", "M"], image: imgGemischtesBrot },
      { nameDe: "Belegte Platte", nameEn: "Cold Cut Platter", descDe: "Ab 4 Personen, nur auf Bestellung", descEn: "From 4 persons, on request only", price: "€14,00/Pers." },
    ],
  },
  {
    keyDe: "Warme Speisen",
    ...
    items: [
      { nameDe: "Kasnockerl mit Krautsalat", nameEn: "Cheese Spaetzle with Coleslaw", price: "€14,90", allergens: ["A", "M", "O", "C", "G"], vegetarian: true, image: imgKaesenockerl },
      { nameDe: "Steirerkäsnockerl mit Krautsalat", nameEn: "Styrian Cheese Spaetzle with Coleslaw", price: "€14,90", allergens: ["A", "C", "G", "M", "O"], vegetarian: true, image: imgKaesenockerl },
      { nameDe: "Eiernockerl mit Krautsalat", nameEn: "Egg Spaetzle with Coleslaw", price: "€12,90", allergens: ["A", "M", "O", "C", "G"], vegetarian: true },
      { nameDe: "Fleischkrapfen mit Sauerkraut", nameEn: "Meat Dumplings with Sauerkraut", price: "€10,50", allergens: ["A", "C", "G"], image: imgFleischkrapfen },
      { nameDe: "Fleischkrapfen", nameEn: "Meat Dumplings", price: "€6,20", allergens: ["A", "C", "G"], image: imgFleischkrapfen },
      { nameDe: "Käsekrainer", nameEn: "Cheese Sausage", descDe: "Mit Senf, Ketchup, Kren und Brot", descEn: "With mustard, ketchup, horseradish and bread", price: "€8,90" },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { nameDe: "Schinken-Käse Toast", nameEn: "Ham & Cheese Toast", price: "€4,50" },
    ],
  },
  {
    keyDe: "Suppen",
    ...
    items: [
      { nameDe: "Kräftige Rindsuppe mit Leberknödel", nameEn: "Beef Broth with Liver Dumpling", price: "€5,20", allergens: ["A", "G", "C", "F", "L", "M"] },
      { nameDe: "Kräftige Rindsuppe mit Kaspressknödel", nameEn: "Beef Broth with Cheese Dumpling", price: "€5,20", allergens: ["A", "G", "C", "F", "L", "M"], vegetarian: true, image: imgKaspress },
      { nameDe: "Kräftige Rindsuppe mit Frittaten", nameEn: "Beef Broth with Pancake Strips", price: "€4,60", allergens: ["A", "G", "C", "F", "L", "M"] },
  ...
  },
  {
    ...
    items: [
      { nameDe: "Most pur/gespritzt", nameEn: "Cider pure/spritzer", descDe: "0,50l", descEn: "0.50l", price: "€4,10" },
      { nameDe: "Most pur/gespritzt", nameEn: "Cider pure/spritzer", descDe: "0,33l", descEn: "0.33l", price: "€3,60" },
      { nameDe: "Gösser Märzen", nameEn: "Gösser Märzen Beer", descDe: "Fl. 0,50l", descEn: "Bottle 0.50l", price: "€4,50" },
      { nameDe: "Gösser Naturradler", nameEn: "Gösser Radler", descDe: "Fl. 0,50l", descEn: "Bottle 0.50l", price: "€4,90" },
      { nameDe: "Gösser Alkoholfrei", nameEn: "Gösser Non-Alcoholic", descDe: "Fl. 0,50l", descEn: "Bottle 0.50l", price: "€4,90" },
      { nameDe: "Weizen / Weizen Alkoholfrei", nameEn: "Wheat Beer / Non-Alcoholic", descDe: "Fl. 0,50l", descEn: "Bottle 0.50l", price: "€5,20" },
      { nameDe: "Gösser Märzen", nameEn: "Gösser Märzen Beer", descDe: "Fl. 0,33l", descEn: "Bottle 0.33l", price: "€3,60" },
    ],
  ...
  },
  {
    ...
    items: [
      { nameDe: "Landwein weiß/rot", nameEn: "House Wine white/red", descDe: "1/8l", descEn: "1/8l", price: "€2,60" },
      { nameDe: "G'spritzter weiß/rot", nameEn: "Wine Spritzer white/red", descDe: "1/4l", descEn: "1/4l", price: "€3,40" },
      { nameDe: "G'spritzter süß", nameEn: "Sweet Wine Spritzer", descDe: "1/4l", descEn: "1/4l", price: "€4,10" },
      { nameDe: "Sommerspritzer", nameEn: "Summer Spritzer", descDe: "1/4l", descEn: "1/4l", price: "€2,90" },
      { nameDe: "Sommerspritzer", nameEn: "Summer Spritzer", descDe: "1/2l", descEn: "1/2l", price: "€5,40" },
      { nameDe: "Aperol Spritz", nameEn: "Aperol Spritz", descDe: "1/4l", descEn: "1/4l", price: "€5,40" },
      { nameDe: "Beeren Schilerol", nameEn: "Berry Schilerol", descDe: "1/4l", descEn: "1/4l", price: "€5,40" },
    ],
  ...
  },
  {
    ...
    items: [
      { nameDe: "Häfer'l Kaffee", nameEn: "Mug of Coffee", price: "€3,60" },
      { nameDe: "Kakao", nameEn: "Hot Cocoa", price: "€3,80" },
      { nameDe: "Portion Schlagobers", nameEn: "Portion of Whipped Cream", price: "€0,90" },
      { nameDe: "Tee", nameEn: "Tea", descDe: "Kräuter, Früchte, Schwarz", descEn: "Herbal, Fruit, Black", price: "€3,20" },
      { nameDe: "Schnapstee", nameEn: "Tea with Schnapps", price: "€5,90" },
    ],
    note: "Alle Getränke nur solange der Vorrat reicht",
  },
  {
    ...
    icon: <Coffee className="w-5 h-5" />,
    items: [
      { nameDe: "Limo", nameEn: "Soft Drink", descDe: "Almdudler, Fanta, Coca-Cola, Coca-Cola Zero (0,33l)", descEn: "Almdudler, Fanta, Coca-Cola, Coca-Cola Zero (0.33l)", price: "€3,90" },
      { nameDe: "Eistee", nameEn: "Iced Tea", descDe: "Pfirsich oder Zitrone (0,33l)", descEn: "Peach or Lemon (0.33l)", price: "€3,90" },
  ...
  },
  {
    ...
    icon: <Coffee className="w-5 h-5" />,
    items: [
      { nameDe: "Fruchtsaft mit Wasser", nameEn: "Fruit Juice with Water", descDe: "Johannisbeere, Marille, Erdbeere, Pfirsich, Apfel (0,33l / 0,50l)", descEn: "Currant, Apricot, Strawberry, Peach, Apple (0.33l / 0.50l)", price: "€3,20 / €4,20" },
      { nameDe: "Fruchtsaft mit Mineral", nameEn: "Fruit Juice with Sparkling Water", descDe: "0,33l / 0,50l", descEn: "0.33l / 0.50l", price: "€3,80 / €4,80" },
  ...
  },
  {
    ...
    icon: <Wine className="w-5 h-5" />,
    items: [
      { nameDe: "Zwetschke", nameEn: "Plum Schnapps", price: "€3,50" },
      { nameDe: "Birne", nameEn: "Pear Schnapps", price: "€3,50" },
      { nameDe: "Spenling", nameEn: "Wild Plum Schnapps", price: "€3,50" },
      { nameDe: "Zirbe", nameEn: "Stone Pine Schnapps", price: "€3,50" },
      { nameDe: "Honig", nameEn: "Honey Schnapps", price: "€3,50" },
    ],
    note: "Alle Getränke nur solange der Vorrat reicht",
  },
  {
